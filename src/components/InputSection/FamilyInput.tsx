  ...
  return (
    <div className="card">
      ...
      <NumberInput
        ...
        onChange={(value) => dispatch({ type: 'UPDATE_FAMILY', field: 'familyMembers', value })}
        min={2}
        max={5}
        label="Family"
      ...
      <NumberInput
        ...
        onChange={(value) => dispatch({ type: 'UPDATE_FAMILY', field: 'clayRooms', value })}
        min={0}
        max={15}
        label="Clay Rooms"
      ...
      <NumberInput
        ...
        onChange={(value) => dispatch({ type: 'UPDATE_FAMILY', field: 'stoneRooms', value })}
        min={0}
        max={15}
        label="Stone Rooms"
